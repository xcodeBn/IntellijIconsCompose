...
val Extannotation: ImageVector
    get() {
        if (_Extannotation != null) return _Extannotation!!

        _Extannotation = ImageVector.Builder(
            name = "Extannotation",
...
private var _Extannotation: ImageVector? = null

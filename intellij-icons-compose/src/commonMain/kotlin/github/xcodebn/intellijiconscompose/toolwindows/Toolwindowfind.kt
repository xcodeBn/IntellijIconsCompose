...
val Toolwindowfind: ImageVector
    get() {
        if (_Toolwindowfind != null) return _Toolwindowfind!!

        _Toolwindowfind = ImageVector.Builder(
            name = "Toolwindowfind",
        ...
        return _Toolwindowfind!!
    }

private var _Toolwindowfind: ImageVector? = null

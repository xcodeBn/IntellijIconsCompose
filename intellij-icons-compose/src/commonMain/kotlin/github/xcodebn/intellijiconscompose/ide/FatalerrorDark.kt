...
val FatalerrorDark: ImageVector
    get() {
        if (_FatalerrorDark != null) return _FatalerrorDark!!

        _FatalerrorDark = ImageVector.Builder(
            name = "FatalerrorDark",
        ...
        return _FatalerrorDark!!
    }

private var _FatalerrorDark: ImageVector? = null

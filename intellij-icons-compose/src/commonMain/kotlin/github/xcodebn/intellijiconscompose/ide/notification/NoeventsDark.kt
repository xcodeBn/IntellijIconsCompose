...
val NoeventsDark: ImageVector
    get() {
        if (_NoeventsDark != null) return _NoeventsDark!!

        _NoeventsDark = ImageVector.Builder(
            name = "NoeventsDark",
        ...
        return _NoeventsDark!!
    }

private var _NoeventsDark: ImageVector? = null

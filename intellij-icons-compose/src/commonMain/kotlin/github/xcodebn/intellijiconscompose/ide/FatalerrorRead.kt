...
val FatalerrorRead: ImageVector
    get() {
        if (_FatalerrorRead != null) return _FatalerrorRead!!

        _FatalerrorRead = ImageVector.Builder(
            name = "FatalerrorRead",
        ...
        return _FatalerrorRead!!
    }

private var _FatalerrorRead: ImageVector? = null

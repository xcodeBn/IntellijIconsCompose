...
val Warningevents: ImageVector
    get() {
        if (_Warningevents != null) return _Warningevents!!

        _Warningevents = ImageVector.Builder(
            name = "Warningevents",
...
private var _Warningevents: ImageVector? = null

...
val Testterminated: ImageVector
    get() {
        if (_Testterminated != null) return _Testterminated!!

        _Testterminated = ImageVector.Builder(
            name = "Testterminated",
...
private var _Testterminated: ImageVector? = null

...
val ShortcutfilterDark: ImageVector
    get() {
        if (_ShortcutfilterDark != null) return _ShortcutfilterDark!!

        _ShortcutfilterDark = ImageVector.Builder(
            name = "ShortcutfilterDark",
        ...
        return _ShortcutfilterDark!!
    }

private var _ShortcutfilterDark: ImageVector? = null

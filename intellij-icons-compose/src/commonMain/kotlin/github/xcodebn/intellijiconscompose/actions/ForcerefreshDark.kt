...
val ForcerefreshDark: ImageVector
    get() {
        if (_ForcerefreshDark != null) return _ForcerefreshDark!!

        _ForcerefreshDark = ImageVector.Builder(
            name = "ForcerefreshDark",
        ...
        return _ForcerefreshDark!!
    }

private var _ForcerefreshDark: ImageVector? = null

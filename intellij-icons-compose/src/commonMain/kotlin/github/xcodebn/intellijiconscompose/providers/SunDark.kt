...
val SunDark: ImageVector
    get() {
        if (_SunDark != null) return _SunDark!!

        _SunDark = ImageVector.Builder(
            name = "SunDark",
            ...
            path(
                fill = SolidColor(Color(0xFF5D87A1))
            ) {
                moveTo(2f, 8f)
                moveTo(4f, 6f)
...
private var _SunDark: ImageVector? = null

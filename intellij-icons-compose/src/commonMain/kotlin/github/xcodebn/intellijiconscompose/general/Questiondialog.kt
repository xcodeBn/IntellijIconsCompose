...
val Questiondialog: ImageVector
    get() {
        if (_Questiondialog != null) return _Questiondialog!!

        _Questiondialog = ImageVector.Builder(
            name = "Questiondialog",
...
private var _Questiondialog: ImageVector? = null

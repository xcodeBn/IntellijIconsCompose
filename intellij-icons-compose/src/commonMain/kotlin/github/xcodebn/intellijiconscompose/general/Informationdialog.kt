...
val Informationdialog: ImageVector
    get() {
        if (_Informationdialog != null) return _Informationdialog!!

        _Informationdialog = ImageVector.Builder(
...
private var _Informationdialog: ImageVector? = null

...
val Localizationsettings: ImageVector
    get() {
        if (_Localizationsettings != null) return _Localizationsettings!!

        _Localizationsettings = ImageVector.Builder(
...
private var _Localizationsettings: ImageVector? = null

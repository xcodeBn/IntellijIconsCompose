...
val ShowerrorDark: ImageVector
    get() {
        if (_ShowerrorDark != null) return _ShowerrorDark!!

        _ShowerrorDark = ImageVector.Builder(
            name = "ShowerrorDark",
        ...
        return _ShowerrorDark!!
    }

private var _ShowerrorDark: ImageVector? = null

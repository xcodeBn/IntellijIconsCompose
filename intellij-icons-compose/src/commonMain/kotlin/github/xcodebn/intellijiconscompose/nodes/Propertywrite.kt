...
val Propertywrite: ImageVector
    get() {
        if (_Propertywrite != null) return _Propertywrite!!

        _Propertywrite = ImageVector.Builder(
            name = "Propertywrite",
            ...
            path(
                ...
                curveTo(4.00f, 11.41f, 3.50f, 12.21f, 2.77f, 12.64f)
                curveTo(4.05f, 14.09f, 5.92f, 15.00f, 8.00f, 15.00f)
        ...
        return _Propertywrite!!
    }

private var _Propertywrite: ImageVector? = null

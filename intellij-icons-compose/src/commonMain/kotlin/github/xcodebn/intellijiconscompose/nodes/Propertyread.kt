...
val Propertyread: ImageVector
    get() {
        if (_Propertyread != null) return _Propertyread!!

        _Propertyread = ImageVector.Builder(
            name = "Propertyread",
            ...
            path(
                ...
                curveTo(1.00f, 9.56f, 1.52f, 11.01f, 2.39f, 12.17f)
                curveTo(3.05f, 12.42f, 3.58f, 12.95f, 3.83f, 13.61f)
                curveTo(5.00f, 14.48f, 6.44f, 15.00f, 8.00f, 15.00f)
...
private var _Propertyread: ImageVector? = null

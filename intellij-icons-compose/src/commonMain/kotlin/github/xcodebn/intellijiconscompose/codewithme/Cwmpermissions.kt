...
val Cwmpermissions: ImageVector
    get() {
        if (_Cwmpermissions != null) return _Cwmpermissions!!

        _Cwmpermissions = ImageVector.Builder(
            name = "Cwmpermissions",
        ...
        return _Cwmpermissions!!
    }

private var _Cwmpermissions: ImageVector? = null

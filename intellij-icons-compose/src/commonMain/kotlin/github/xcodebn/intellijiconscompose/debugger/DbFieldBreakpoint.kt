...
val DbFieldBreakpoint: ImageVector
    get() {
        if (_DbFieldBreakpoint != null) return _DbFieldBreakpoint!!

        _DbFieldBreakpoint = ImageVector.Builder(
            name = "DbFieldBreakpoint",
        ...
        return _DbFieldBreakpoint!!
    }

private var _DbFieldBreakpoint: ImageVector? = null

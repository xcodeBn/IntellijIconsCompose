...
val DbInvalidBreakpoint: ImageVector
    get() {
        if (_DbInvalidBreakpoint != null) return _DbInvalidBreakpoint!!

        _DbInvalidBreakpoint = ImageVector.Builder(
            name = "DbInvalidBreakpoint",
        ...
        return _DbInvalidBreakpoint!!
    }

private var _DbInvalidBreakpoint: ImageVector? = null

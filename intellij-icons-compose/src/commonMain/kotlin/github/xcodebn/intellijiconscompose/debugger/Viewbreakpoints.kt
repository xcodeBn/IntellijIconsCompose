...
val Viewbreakpoints: ImageVector
    get() {
        if (_Viewbreakpoints != null) return _Viewbreakpoints!!

        _Viewbreakpoints = ImageVector.Builder(
            name = "Viewbreakpoints",
...
private var _Viewbreakpoints: ImageVector? = null

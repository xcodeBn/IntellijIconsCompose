...
val Mutebreakpoints: ImageVector
    get() {
        if (_Mutebreakpoints != null) return _Mutebreakpoints!!

        _Mutebreakpoints = ImageVector.Builder(
...
private var _Mutebreakpoints: ImageVector? = null
